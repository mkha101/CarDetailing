  ...
  return (
    <div className="w-full sm:px-44 min-h-screen bg-black  pt-36 flex flex-col   gap-10 max-w-screen ">
      <div className="hidden sm:flex sm:items-center uppercase px-3  text-white justify-center gap-3 flex-col ">
        <h1 className="text-lg sm:text-xl font-medium underline decoration-[#FE3C3B] decoration-2 underline-offset-8">
          Get a Quote
        </h1>
          ...
          <form>
            <div className="flex w-96 flex-col text-black gap-5 border bg-zinc-100 shadow-xl sm:w-full  mb-20  py-5 rounded-3xl  ">
              ...
              <div className="flex items-center justify-center">
                ...
                <Button
                  type="submit"
                  className="bg-[#FE3C3B] hover:bg-blue-400 text-white tracking-wide font-semibold text-xl  transition  duration-100 ease-in-out  w-full mx-6 rounded-full  "
                >
                  Submit
                </Button>
              </div>
