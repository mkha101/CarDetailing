...
export const ServicesOffered = () => {
  return (
    <div className="bg-black text-black">
      ...
      <div className="grid  sm:grid-cols-2 grid-col-4 sm:max-h-screen border-x-[4px] sm:border-x-[16px] max-sm:pb-5  sm:gap-3 border-black min-w-screen w-full grid-rows-4 sm:grid-rows-2 text-white">
        <div className="relative sm:border-[8px] max-sm:p-4   cursor-pointer border-black bg-cover bg-center bg-no-repeat">
          <img
            src="/rims.jpeg"
            alt=""
